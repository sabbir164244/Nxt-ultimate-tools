...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 p-6 bg-black/20 backdrop-blur-lg border-b border-white/10">
      ...
      {/* Hero Section */}
      <section id="home" className="relative z-10 pt-20 pb-16 px-6">
            ...
            {[
              {
                ...
                a: "Yes! All 40+ tools are completely free with no hidden charges or premium features."
              },
              {
                q: "Is my data safe when using these tools?",
                a: "Absolutely. All processing is done locally in your browser. Your files never leave your device."
              },
              {
                q: "Do I need to create an account?",
                a: "No account required! Simply visit the website and start using any tool immediately."
              },
              {
              ...
              },
              {
                ...
                a: "We regularly add new tools based on user feedback and emerging needs in productivity."
              }
            ].map((faq, index) => (
      ...
      {/* Footer */}
      <footer className="relative z-10 py-12 px-6 bg-black/30 border-t border-white/10">
